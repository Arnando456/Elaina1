...
${a}❏MAKER MENU${a}
 ...
 ${a}│•${prefix}neon
 ${a}│•${prefix}greenneon
 ${a}│•${prefix}advanceglow
 ${a}│•${prefix}futureneon
 ${a}│•${prefix}sandwriting
 ${a}│•${prefix}sandsummer*
 ${a}│•${prefix}sandengraved*
 ${a}│•${prefix}metaldark*
 ${a}│•${prefix}neonlight*
 ${a}│•${prefix}holographic*
 ${a}│•${prefix}text1917*
 ${a}│•${prefix}minion*
 ${a}│•${prefix}deluxesilver*
 ${a}│•${prefix}newyearcard*
 ${a}│•${prefix}bloodfrosted*
 ${a}│•${prefix}halloween*
 ${a}│•${prefix}jokerlogo*
 ${a}│•${prefix}fireworksparkle*
 ${a}│•${prefix}natureleaves*
 ${a}│•${prefix}bokeh*
 ${a}│•${prefix}toxic*
 ${a}│•${prefix}strawberry*
 ${a}│•${prefix}box3d*
 ${a}│•${prefix}roadwarning*
 ${a}│•${prefix}breakwall*
 ${a}│•${prefix}icecold*
 ${a}│•${prefix}luxury*
 ${a}│•${prefix}cloud*
 ${a}│•${prefix}summersand*
 ${a}│•${prefix}horrorblood*
 ${a}│•${prefix}thunder*
 ${a}│•${prefix}christmas*
 ${a}│•${prefix}sticker${a}
